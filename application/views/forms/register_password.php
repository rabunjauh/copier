<div class="container box">
    ...
    <div class="row">
        <div class="col-lg-6">
            <?php 
                ...
                $sharp_password_data = array(
                    ...
                    'class' => 'form-control',
                    'value' => strval($sharp_password_integer),
                    'readonly' => 'readonly'
                );
                ...
                $other_password_data = array(
                    ...
                    'class' => 'form-control',
                    'value' => strval(substr($other_password_integer_to_string,1)),
                    'readonly' => 'readonly'
                );
        ...
        <div class="col-lg-6">
            <?php echo form_label('Employee ID: ', $idemployee_data['name']); ?>
            ...
            ?>
                    <span class="input-group-btn">
                        <button class="btn btn-default" type="button" id="btnSearchEmployee">Search Employee</button>
                    </span>
                </div>  
            ...
            ?>
                ...
                <div class="form-group">
            <?php
                echo form_label('Department: ', $employee_department_desc_data['name']);
            ...
            ?>
                ...
                <div class="form-group">
            <?php
                echo form_label('Position: ', $employee_position_desc_data['id']);
